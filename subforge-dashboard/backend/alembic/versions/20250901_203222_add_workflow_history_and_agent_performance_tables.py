...
def upgrade() -> None:
    ...
    op.create_index(
        "idx_workflow_history_duration",
        "workflow_history",
        ["duration_seconds"],
        unique=False,
    )
    op.create_index(
        "idx_workflow_history_execution",
        "workflow_history",
        ["workflow_id", "execution_number"],
        unique=False,
    )
    op.create_index(
        "idx_workflow_history_project_time",
        "workflow_history",
        ["project_id", "started_at"],
        unique=False,
    )
    op.create_index(
        "idx_workflow_history_status_time",
        "workflow_history",
        ["status", "started_at"],
        unique=False,
    )
    op.create_index(
        op.f("ix_workflow_history_completed_at"),
        "workflow_history",
        ["completed_at"],
        unique=False,
    )
    op.create_index(
        op.f("ix_workflow_history_execution_id"),
        "workflow_history",
        ["execution_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_workflow_history_id"), "workflow_history", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_workflow_history_project_id"),
        "workflow_history",
        ["project_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_workflow_history_started_at"),
        "workflow_history",
        ["started_at"],
        unique=False,
    )
    op.create_index(
        op.f("ix_workflow_history_status"), "workflow_history", ["status"], unique=False
    )
    op.create_index(
        op.f("ix_workflow_history_workflow_id"),
        "workflow_history",
        ["workflow_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_workflow_history_workflow_name"),
        "workflow_history",
        ["workflow_name"],
        unique=False,
    )
    op.create_index(
        op.f("ix_workflow_history_workflow_type"),
        "workflow_history",
        ["workflow_type"],
        unique=False,
    )
    ...
    op.create_index(
        "idx_phase_history_agent",
        "phase_history",
        ["assigned_agent_id", "started_at"],
        unique=False,
    )
    op.create_index(
        "idx_phase_history_duration",
        "phase_history",
        ["duration_seconds"],
        unique=False,
    )
    op.create_index(
        "idx_phase_history_status_time",
        "phase_history",
        ["status", "started_at"],
        unique=False,
    )
    op.create_index(
        "idx_phase_history_workflow_order",
        "phase_history",
        ["workflow_history_id", "phase_order"],
        unique=False,
    )
    op.create_index(
        op.f("ix_phase_history_assigned_agent_id"),
        "phase_history",
        ["assigned_agent_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_phase_history_phase_name"),
        "phase_history",
        ["phase_name"],
        unique=False,
    )
    op.create_index(
        op.f("ix_phase_history_phase_order"),
        "phase_history",
        ["phase_order"],
        unique=False,
    )
    op.create_index(
        op.f("ix_phase_history_phase_type"),
        "phase_history",
        ["phase_type"],
        unique=False,
    )
    op.create_index(
        op.f("ix_phase_history_result"), "phase_history", ["result"], unique=False
    )
    op.create_index(
        op.f("ix_phase_history_started_at"),
        "phase_history",
        ["started_at"],
        unique=False,
    )
    op.create_index(
        op.f("ix_phase_history_status"), "phase_history", ["status"], unique=False
    )
    op.create_index(
        op.f("ix_phase_history_workflow_history_id"),
        "phase_history",
        ["workflow_history_id"],
        unique=False,
    )
    ...
    op.create_index(
        "idx_handoff_history_agents",
        "handoff_history",
        ["source_agent_id", "target_agent_id"],
        unique=False,
    )
    op.create_index(
        "idx_handoff_history_duration",
        "handoff_history",
        ["duration_seconds"],
        unique=False,
    )
    op.create_index(
        "idx_handoff_history_phases",
        "handoff_history",
        ["source_phase_name", "target_phase_name"],
        unique=False,
    )
    op.create_index(
        "idx_handoff_history_status",
        "handoff_history",
        ["status", "initiated_at"],
        unique=False,
    )
    op.create_index(
        "idx_handoff_history_workflow_time",
        "handoff_history",
        ["workflow_history_id", "initiated_at"],
        unique=False,
    )
    op.create_index(
        op.f("ix_handoff_history_handoff_name"),
        "handoff_history",
        ["handoff_name"],
        unique=False,
    )
    op.create_index(
        op.f("ix_handoff_history_handoff_type"),
        "handoff_history",
        ["handoff_type"],
        unique=False,
    )
    op.create_index(
        op.f("ix_handoff_history_id"), "handoff_history", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_handoff_history_initiated_at"),
        "handoff_history",
        ["initiated_at"],
        unique=False,
    )
    op.create_index(
        op.f("ix_handoff_history_result"), "handoff_history", ["result"], unique=False
    )
    op.create_index(
        op.f("ix_handoff_history_source_agent_id"),
        "handoff_history",
        ["source_agent_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_handoff_history_source_phase_name"),
        "handoff_history",
        ["source_phase_name"],
        unique=False,
    )
    op.create_index(
        op.f("ix_handoff_history_status"), "handoff_history", ["status"], unique=False
    )
    op.create_index(
        op.f("ix_handoff_history_target_agent_id"),
        "handoff_history",
        ["target_agent_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_handoff_history_target_phase_name"),
        "handoff_history",
        ["target_phase_name"],
        unique=False,
    )
    op.create_index(
        op.f("ix_handoff_history_workflow_history_id"),
        "handoff_history",
        ["workflow_history_id"],
        unique=False,
    )
    ...
    op.create_index(
        "idx_agent_perf_agent_period",
        "agent_performance_metrics",
        ["agent_id", "period_start", "period_end"],
        unique=False,
    )
    op.create_index(
        "idx_agent_perf_quality",
        "agent_performance_metrics",
        ["average_quality_score", "period_start"],
        unique=False,
    )
    op.create_index(
        "idx_agent_perf_trend",
        "agent_performance_metrics",
        ["performance_trend", "period_start"],
        unique=False,
    )
    op.create_index(
        "idx_agent_perf_type_period",
        "agent_performance_metrics",
        ["agent_type", "period_type", "period_start"],
        unique=False,
    )
    op.create_index(
        "idx_agent_perf_utilization",
        "agent_performance_metrics",
        ["utilization_percentage", "period_start"],
        unique=False,
    )
    op.create_index(
        op.f("ix_agent_performance_metrics_agent_id"),
        "agent_performance_metrics",
        ["agent_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_agent_performance_metrics_agent_type"),
        "agent_performance_metrics",
        ["agent_type"],
        unique=False,
    )
    op.create_index(
        op.f("ix_agent_performance_metrics_id"),
        "agent_performance_metrics",
        ["id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_agent_performance_metrics_period_end"),
        "agent_performance_metrics",
        ["period_end"],
        unique=False,
    )
    op.create_index(
        op.f("ix_agent_performance_metrics_period_start"),
        "agent_performance_metrics",
        ["period_start"],
        unique=False,
    )
    op.create_index(
        op.f("ix_agent_performance_metrics_period_type"),
        "agent_performance_metrics",
        ["period_type"],
        unique=False,
    )
    op.create_index(
        op.f("ix_agent_performance_metrics_performance_trend"),
        "agent_performance_metrics",
        ["performance_trend"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_agent_performance_metrics_id"), table_name="agent_performance_metrics"
    )
    op.drop_index(
        op.f("ix_agent_performance_metrics_agent_type"),
        table_name="agent_performance_metrics",
    ...
    op.drop_index(
        op.f("ix_handoff_history_workflow_history_id"), table_name="handoff_history"
    )
    op.drop_index(
        op.f("ix_handoff_history_target_phase_name"), table_name="handoff_history"
    )
    op.drop_index(
        op.f("ix_handoff_history_target_agent_id"), table_name="handoff_history"
    )
    op.drop_index(op.f("ix_handoff_history_status"), table_name="handoff_history")
    op.drop_index(
        op.f("ix_handoff_history_source_phase_name"), table_name="handoff_history"
    )
    op.drop_index(
        op.f("ix_handoff_history_source_agent_id"), table_name="handoff_history"
    )
    ...
    op.drop_index(
        op.f("ix_phase_history_workflow_history_id"), table_name="phase_history"
    )
    ...
    op.drop_index(
        op.f("ix_phase_history_assigned_agent_id"), table_name="phase_history"
    )
    ...
    op.drop_index(
        op.f("ix_workflow_history_workflow_type"), table_name="workflow_history"
    )
    op.drop_index(
        op.f("ix_workflow_history_workflow_name"), table_name="workflow_history"
    )
    op.drop_index(
        op.f("ix_workflow_history_workflow_id"), table_name="workflow_history"
    )
    ...
    op.drop_index(
        op.f("ix_workflow_history_execution_id"), table_name="workflow_history"
    )
    op.drop_index(
        op.f("ix_workflow_history_completed_at"), table_name="workflow_history"
    )
