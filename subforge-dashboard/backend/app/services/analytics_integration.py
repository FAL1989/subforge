...
from ..websocket.enhanced_manager import enhanced_websocket_manager, WebSocketMessage, MessageType
    ...
    def get_status(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "analytics_service_status": (
                ...
                if self.analytics_service else None
            )
        }
