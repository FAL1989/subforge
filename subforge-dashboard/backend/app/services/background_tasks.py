        ...
        def wrapper(self, *args, **kwargs):
            ...
            try:
                ...
                if isinstance(result, TaskResult):
                    ...
                    asyncio.run(background_task_service.complete_task(task_id, task_result))
                ...
                asyncio.run(background_task_service.complete_task(task_id, error_result))
                raise
...
def process_agent_configuration(self, agent_id: str, config_data: dict):
    ...
    try:
        ...
        for step in range(total_steps):
            ...
            # Update progress
            asyncio.run(background_task_service.update_task_progress(
                self.request.id,
                progress,
...
def analyze_system_metrics(self, time_range: str = "24h"):
    ...
    try:
        ...
        return TaskResult(
            success=True,
            data=insights,
            metadata={"analysis_time_range": time_range}
        )
