...
async def get_workflow_context(workflow_id: str):
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Failed to retrieve workflow context")
...
async def get_workflow_phases(workflow_id: str):
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Failed to retrieve workflow phases")
...
async def get_workflow_activities(workflow_id: str):
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Failed to retrieve workflow activities")
...
async def get_integration_status():
    ...
    try:
        ...
        is_file_watching = subforge_integration.observer is not None and subforge_integration.observer.is_alive()
        ...
        status_data = {
            ...
            "active_workflows": len([w for w in subforge_integration.workflows.values() if w.status == "active"]),
            ...
            "last_scan": subforge_integration._last_scan.isoformat() if subforge_integration._last_scan else None,
            "configuration": {
...
async def stop_integration():
    ...
    try:
        ...
        return JSONResponse(
            content={"message": "Integration stopped successfully", "status": "inactive"}
        )
    ...
    try:
        ...
        while True:
            ...
            if message_type == "ping":
                ...
                logger.info(f"Received unhandled SubForge WebSocket message: {message_type}")
