...
class ServiceManager:
    ...
    def start_celery_worker(self) -> bool:
        ...
        try:
            ...
            self.celery_worker_process = subprocess.Popen([
                "celery", "-A", "app.services.background_tasks.celery_app", "worker",
                "--loglevel=info",
    ...
    def start_fastapi_server(self) -> bool:
        ...
        try:
            ...
            print(f"✅ FastAPI server started on http://{settings.HOST}:{settings.PORT}")
            return True
    ...
    def stop_all_services(self):
        ...
        for process in [self.fastapi_process, self.celery_worker_process, self.redis_process]:
            if process:
                try:
                    process.terminate()
