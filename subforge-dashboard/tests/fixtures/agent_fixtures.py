...
def agent_status_updates():
    ...
    return [
        ...
        {"status": "idle"},
        {"status": "error", "error_message": "Connection timeout"},
    ]
...
def agent_heartbeat_data():
    ...
    return {
        ...
        "status": "active",
        "current_task_id": str(uuid.uuid4()),
        "metrics": {"cpu_usage": 45.2, "memory_usage": 68.7, "active_connections": 12},
    }
    ...
    def _generate_bulk_data(count: int = 100) -> List[Dict[str, Any]]:
        ...
        for i in range(count):
            agent_data = agent_factory(
                ...
                configuration={"bulk_test": True, "index": i, "batch_size": count},
            )
    ...
    return [
        ...
        },
        {
            ...
            "data": {
                "agent_id": str(uuid.uuid4()),
                "status": "busy",
                "current_task": {"id": str(uuid.uuid4()), "title": "Processing data"},
            },
        },
        {
        ...
        {"type": "agent_deleted", "data": {"agent_id": str(uuid.uuid4())}},
    ]
...
def invalid_agent_data():
    ...
    return [
        ...
        {"name": "", "agent_type": "test", "status": "idle"},  # Empty name
        {"name": "test-agent", "agent_type": "", "status": "idle"},  # Empty type
        {
            "name": "test-agent",
            "agent_type": "test",
        ...
        # Invalid data types
        {"name": 123, "agent_type": "test", "status": "idle"},  # Should be string
        {
            "name": "test-agent",
            "agent_type": "test",
            "status": "idle",
...
def agent_schema_factory():
    ...
    def _create_agent_create(
        name: str = "test-agent", agent_type: str = "test", **kwargs
    ) -> AgentCreate:
        return AgentCreate(
            name=name,
            agent_type=agent_type,
    ...
    return {"create": _create_agent_create, "update": _create_agent_update}
...
def mock_external_services():
    ...
    return {
        ...
        "monitoring": {
            ...
            "responses": {
                "metrics": {"cpu_usage": 45.2, "memory_usage": 68.7, "disk_usage": 42.1}
            },
        },
    }